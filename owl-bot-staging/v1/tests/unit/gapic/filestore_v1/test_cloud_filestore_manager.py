...
from google.cloud.filestore_v1.services.cloud_filestore_manager import CloudFilestoreManagerAsyncClient
...
@pytest.mark.parametrize("client_class", [
    CloudFilestoreManagerClient, CloudFilestoreManagerAsyncClient
])
@mock.patch.object(CloudFilestoreManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudFilestoreManagerClient))
@mock.patch.object(CloudFilestoreManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudFilestoreManagerAsyncClient))
...
def test_restore_instance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_instance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_snapshots_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, cloud_filestore_service.Snapshot)
                   for i in results)
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_instances") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_list_instances") as pre:
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_instance") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_instance") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_create_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_instance") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_restore_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_restore_instance") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_restore_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_instance") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_delete_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_snapshots") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_list_snapshots") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_snapshot") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_get_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_snapshot") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_create_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_snapshot") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_delete_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_snapshot") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_update_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_list_backups") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_get_backup") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_create_backup") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_create_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_delete_backup") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "post_update_backup") as post, \
         mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, "pre_update_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CloudFilestoreManagerGrpcTransport, transports.CloudFilestoreManagerGrpcAsyncIOTransport])
def test_cloud_filestore_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
