...
from google.cloud.filestore_v1.services.cloud_filestore_manager.transports.base import _GOOGLE_AUTH_VERSION
...
def test_cloud_filestore_manager_client_client_options_credentials_file(client_class, transport_class, transport_name):
