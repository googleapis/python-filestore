...
class CloudFilestoreManagerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_instance(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_create_snapshot(self, request: cloud_filestore_service.CreateSnapshotRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.CreateSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_instance(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_snapshot(self, request: cloud_filestore_service.DeleteSnapshotRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.DeleteSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_instance(self, response: cloud_filestore_service.Instance) -> cloud_filestore_service.Instance:
        ...
        """
        return response
    def pre_get_snapshot(self, request: cloud_filestore_service.GetSnapshotRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.GetSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_instances(self, response: cloud_filestore_service.ListInstancesResponse) -> cloud_filestore_service.ListInstancesResponse:
        ...
        """
        return response
    def pre_list_snapshots(self, request: cloud_filestore_service.ListSnapshotsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.ListSnapshotsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_instance(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_update_snapshot(self, request: cloud_filestore_service.UpdateSnapshotRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloud_filestore_service.UpdateSnapshotRequest, Sequence[Tuple[str, str]]]:
