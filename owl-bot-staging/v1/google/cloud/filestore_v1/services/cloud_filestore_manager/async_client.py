...
class CloudFilestoreManagerAsyncClient:
    ...
    get_transport_class = functools.partial(type(CloudFilestoreManagerClient).get_transport_class, type(CloudFilestoreManagerClient))
...
initial=0.25,maximum=32.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def restore_instance(self,
    ...
    async def create_snapshot(self,
        ...
        Args:
            request (Optional[Union[google.cloud.filestore_v1.types.CreateSnapshotRequest, dict]]):
    ...
    async def delete_snapshot(self,
        ...
        Args:
            request (Optional[Union[google.cloud.filestore_v1.types.DeleteSnapshotRequest, dict]]):
