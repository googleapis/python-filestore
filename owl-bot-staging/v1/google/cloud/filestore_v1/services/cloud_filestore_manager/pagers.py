...
class ListSnapshotsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.filestore_v1.types.ListSnapshotsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``snapshots`` field.
    ...
    All the usual :class:`google.cloud.filestore_v1.types.ListSnapshotsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., cloud_filestore_service.ListSnapshotsResponse],
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.filestore_v1.types.ListSnapshotsRequest):
                The initial request object.
            response (google.cloud.filestore_v1.types.ListSnapshotsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        self._method = method
        self._request = cloud_filestore_service.ListSnapshotsRequest(request)
        self._response = response
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[cloud_filestore_service.ListSnapshotsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, metadata=self._metadata)
    ...
    def __iter__(self) -> Iterator[cloud_filestore_service.Snapshot]:
        for page in self.pages:
...
class ListSnapshotsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[cloud_filestore_service.ListSnapshotsResponse]],
            request: cloud_filestore_service.ListSnapshotsRequest,
            response: cloud_filestore_service.ListSnapshotsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[cloud_filestore_service.ListSnapshotsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[cloud_filestore_service.Snapshot]:
        async def async_generator():
            async for page in self.pages:
